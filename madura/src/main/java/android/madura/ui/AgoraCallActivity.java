...
//import android.rahardyan.tescallmodularity.MainActivity;
...
//import android.rahardyan.tescallmodularity.headset.HeadsetBroadcastReceiver;
//import android.rahardyan.tescallmodularity.headset.HeadsetPlugManager;
//import android.rahardyan.tescallmodularity.headset.IHeadsetPlugListener;
...
//
//public class AgoraCallActivity extends BaseActivity implements AGEventHandler, IHeadsetPlugListener {
...
//                Log.d("amsibsam", "onServiceConnected " + profile + " " + headset);
...
//            Log.d("amsibsam", "onServiceDisconnected " + profile);
...
//
//
//        Log.d("amsibsam", "mUid "+config().mUid);
...
//        Log.d("amsibsam", "onClickHideIME " + view);
//
...
//            Log.w("AgoraCallActivity", errorMsg);
...
//        Log.i("AgoraCallActivity", "onEndCallClicked " + view);
//
//        quitCall();
//    }
//
...
//        super.onBackPressed();
//
//        Log.i("AgoraCallActivity", "onBackPressed");
//
//        quitCall();
//    }
//
...
//        Log.i("AgoraCallActivity", "onVoiceMuteClicked " + view + " " + mUidsList.size() + " video_status: " + mVideoMuted + " audio_status: " + mAudioMuted);
//        if (mUidsList.size() == 0) {
//            return;
//        }
//
...
//
//                if (useDefaultLayout) {
//                    Log.d("amsibsam", "doRenderRemoteUi LAYOUT_TYPE_DEFAULT " + (uid & 0xFFFFFFFFL));
//                    switchToDefaultVideoView();
//                } else {
//                    int bigBgUid = mSmallVideoViewAdapter == null ? uid : mSmallVideoViewAdapter.getExceptedUid();
//                    Log.d("amsibsam", "doRenderRemoteUi LAYOUT_TYPE_SMALL " + (uid & 0xFFFFFFFFL) + " " + (bigBgUid & 0xFFFFFFFFL));
...
//        Log.d("amsibsam", "onJoinChannelSuccess " + channel + " " + (uid & 0xFFFFFFFFL) + " " + elapsed);
//
//        runOnUiThread(new Runnable() {
//            @Override
//            public void run() {
...
//        Log.i("AgoraCallActivity", "notifyHeadsetPlugged " + plugged + " " + extraData);
